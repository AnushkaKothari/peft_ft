...
from functions.function_scinews_qlora import (notebook_login, setup_environment, set_seed, load_and_prepare_dataset, 
...
def main():
    ...
    config = {
        ...
        "random_seed": 2024,
        "huggingface_model": "Anushka1304/vicuna7b_v15_rank4_scinews_qlora_full", # TO CHANGE with Dataset Size
        ...
        "result_json":"results_scinews_rank4_qlora_full.json", # TO CHANGE with Dataset Size
        "training_args": {
