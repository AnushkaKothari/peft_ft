...
from functions.function_scinews import (notebook_login, setup_environment, set_seed, load_and_prepare_dataset, 
...
def main():
    ...
    config = {
        ...
        "wandb_project": "Vicuna7b_scinews",
        "random_seed": 2024,
        "huggingface_model": "Anushka1304/vicuna7b_v15_rank4_scinews_ia3_full", # TO CHANGE with Dataset Size
        ...
        "result_json":"results_scinews_rank4_ia3_full.json", # TO CHANGE with Dataset Size
        "training_args": {
