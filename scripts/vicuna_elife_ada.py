...
def main():
    ...
    config = {
        ...
        "random_seed": 2024,
        "huggingface_model": "Anushka1304/vicuna7b_v15_rank4_elife_adalora_full", # TO CHANGE with Dataset Size
        ...
        "result_json":"results_elife_rank4_adalora_full.json", # TO CHANGE with Dataset Size
        "training_args": {
