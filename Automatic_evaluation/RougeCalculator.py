    ...
    def compute_score(self, input_data):
        ...
        for pair in input_data:
            ...
            if isinstance(scores, dict):
                scores = {k: round(v * 100, 4) if isinstance(v, (int, float)) else round(v.mid.fmeasure * 100, 4) for k, v in scores.items()}
...
if __name__ == '__main__':
    ...
    rouge_calculator.compute_from_file(input_json_path, output_json_path)
